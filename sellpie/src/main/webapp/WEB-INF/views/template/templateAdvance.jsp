...
<head>
  ...
  <link href="resources/css/adminCss/bootstrap.min.css" rel="stylesheet">

  <link href="resources/fonts/css/adminCss/font-awesome.min.css" rel="stylesheet">
  <link href="resources/css/adminCss/animate.min.css" rel="stylesheet">

  <!-- Custom styling plus plugins -->
  <link href="resources/css/adminCss/custom.css" rel="stylesheet">
  <link href="resources/css/adminCss/icheck/flat/green.css" rel="stylesheet">
  <!-- ion_range -->
  <link rel="stylesheet" href="resources/css/adminCss/normalize.css" />
  <link rel="stylesheet" href="resources/css/adminCss/ion.rangeSlider.css" />
  <link rel="stylesheet" href="resources/css/adminCss/ion.rangeSlider.skinFlat.css" />

  <!-- colorpicker -->
  <link href="resources/css/adminCss/colorpicker/bootstrap-colorpicker.min.css" rel="stylesheet">

  <script src="resources/js/jquery.min.js"></script>

  <!--[if lt IE 9]>
        <script src="../assets/resources/js/ie8-responsive-file-warning.js"></script>
        <![endif]-->
...
<body class="nav-md">
  ...
  <!-- input mask -->
  <script src="resources/js/input_mask/jquery.inputmask.js"></script>
  <!-- knob -->
  <script src="resources/js/knob/jquery.knob.min.js"></script>
  <!-- range slider -->
  <script src="resources/js/ion_range/ion.rangeSlider.min.js"></script>
  <!-- color picker -->
  <script src="resources/js/colorpicker/bootstrap-colorpicker.min.js"></script>
  <script src="resources/js/colorpicker/docs.js"></script>

  <!-- image cropping -->
  <script src="resources/js/cropping/cropper.min.js"></script>
  <script src="resources/js/cropping/main2.js"></script>
  <!-- pace -->
