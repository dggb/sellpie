...
<head>
	...
	<link rel="stylesheet" type="text/css" href="resources/css/adminCss/maps/jquery-jvectormap-2.0.3.css" />
	<link href="resources/css/adminCss/icheck/flat/green.css" rel="stylesheet" />
	<link href="resources/css/adminCss/floatexamples.css" rel="stylesheet" type="text/css" />
			...
			<div class="col-md-3 left_col">
				<div class="left_col scroll-view">
					...
					<div class="navbar nav_title" style="border: 0;">
						<a href="#" class="site_title"><i class="fa fa-paw"></i> <span>Empty!</span></a>
					</div>
			...
			<div class="right_col" role="main">
				...
				<footer>
					<div class="copyright-info">
						<p class="pull-right">Gentelella - Bootstrap Admin Template by <a href="#">Colorlib</a>		
						</p>
					</div>
					<div class="clearfix"></div>
				</footer>
